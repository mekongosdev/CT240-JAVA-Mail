 ...
 * @author Sj
 */
public final class SyncTrash implements Runnable {
    ...
    MainForm mf;
    ConnectSql connect;
    public SyncTrash(MainForm mf, String username, String password, String host){  
...
//        emailSession.setDebug(true);
    ...
    public void run() {        
        try{
            System.out.println("Syncing Trash.......");
...
//                System.out.println("Get message "+(i+1));
            ...
            System.out.println("not Syncing Trash....");
        }
        if (mf.isSynced(box)){
    ...
    private void syncDB(){
        ...
        for (Mes message: MessagesSync){
            connect.insertTrash(message.id[0],message.date.toString(),message.from,message.subject);
        }
